...
export default function Sidebar({ }: Props) {
    ...
    return (
        ...
        <div className={`md:w-40 w-52 z-30 bg-[#020817] md:flex flex-col border-r-2 fixed md:relative transition-transform duration-300 ${collapsed ? '-translate-x-full' : 'translate-x-0'} rounded-l-lg`}>
